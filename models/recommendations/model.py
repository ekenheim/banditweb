"""
recommendations.py — Product Recommendation contextual bandit (self-contained)
────────────────────────────────────────────────────────────────────────────────
LinUCB variant for learning which product category to surface per user type.
Context: 4-dim one-hot encoding of user type [tech, fashion, outdoors, reader].
...
class RecommendationBanditModel(BanditBase):

    MLFLOW_EXPERIMENT = "bandit-recommendations"
